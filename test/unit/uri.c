...
main(void)
{
	...
	/* Host */
	test("try.bee.org", NULL, NULL, NULL, "try.bee.org", NULL,
	     NULL, NULL, NULL, 0);
	...
	/* Web */
	test("http://bee.org/dist/master/debian/pool/main/t/bee/"
	     "bee_1.6.3+314+g91066ee+20140910+1434.orig.tar.gz",
	     "http", NULL, NULL, "bee.org", NULL,
	     "/dist/master/debian/pool/main/t/bee/"
	     "bee_1.6.3+314+g91066ee+20140910+1434.orig.tar.gz",
	     NULL, NULL, 0);

	test("https://www.google.com/search?"
	     "safe=off&site=&tbm=isch&source=hp&biw=1918&bih=1109&q=Bee"
	     "&oq=Bee&gs_l=img.3..0i24l3j0i10i24j0i24&gws_rd=ssl",
