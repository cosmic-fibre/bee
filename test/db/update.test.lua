...
db.tuple.new({1, 2, 3, 4, 5}):update({{'!', 0, 'Test'}})
db.tuple.new({1, 2, 3, 4, 5}):update({{'!', -1, 'Test'}})
db.tuple.new({1, 2, 3, 4, 5}):update({{'!', -3, 'Test'}})
db.tuple.new({1, 2, 3, 4, 5}):update({{'!', -5, 'Test'}})
db.tuple.new({1, 2, 3, 4, 5}):update({{'!', -6, 'Test'}})
db.tuple.new({1, 2, 3, 4, 5}):update({{'!', -7, 'Test'}})
db.tuple.new({1, 2, 3, 4, 5}):update({{'!', -100500, 'Test'}})
...
db.tuple.new({1, 2, 3, 4, 5}):update({{'+', 0, 100}})
db.tuple.new({1, 2, 3, 4, 5}):update({{'+', -1, 100}})
db.tuple.new({1, 2, 3, 4, 5}):update({{'+', -3, 100}})
db.tuple.new({1, 2, 3, 4, 5}):update({{'+', -5, 100}})
db.tuple.new({1, 2, 3, 4, 5}):update({{'+', -6, 100}})
db.tuple.new({1, 2, 3, 4, 5}):update({{'+', -100500, 100}})
...
db.tuple.new({1, 2, 3, 4, 5}):update({{'#', 0, 1}})
db.tuple.new({1, 2, 3, 4, 5}):update({{'#', -1, 1}})
db.tuple.new({1, 2, 3, 4, 5}):update({{'#', -3, 1}})
db.tuple.new({1, 2, 3, 4, 5}):update({{'#', -5, 1}})
db.tuple.new({1, 2, 3, 4, 5}):update({{'#', -6, 1}})
db.tuple.new({1, 2, 3, 4, 5}):update({{'#', -100500, 1}})
...
ffi = require('ffi')
s = db.schema.create_space('tweedledum')
index = s:create_index('pk')
s:insert{0, -1}
-- + --
s:update({0}, {{'+', 2, "a"}}) -- err
