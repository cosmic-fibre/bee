...
.. confval:: sham_dir
    ...
    A directory where sham files will be stored. Can be relative to
    :confval:`work_dir`. If not specified, defaults to :file:`work_dir/sham`.
...
.. confval:: pid_file
    ...
    A typical value is “:file:`bee.pid`”.
...
.. confval:: custom_proc_title
    ...
    .. NOTE::
        ...
        For example, ordinarily ps shows the Bee server process thus:

        .. code-block:: lua

            $ ps -ef | grep bee
            1000     22364  2778  0 09:14 pts/0    00:00:00 bee: running
            1000     22394 22364  0 09:14 pts/0    00:00:00 bee: spawner
            bee: primary pri: 3301 adm: 3313
        ...
        .. code-block:: lua
            ...
            $ ps -ef | grep bee
            1000     22364  2778  0 09:14 pts/0    00:00:00 bee: running@sessions
            1000     22394 22364  0 09:14 pts/0    00:00:00 bee: spawner@sessions
            bee: primary pri: 3301 adm: 3313
