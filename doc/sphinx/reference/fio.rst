...
Bee supports file input/output with an API that is similar to POSIX
...
.. function:: pathjoin(partial-string [, partial-string ...])
    ...
    .. code-block:: lua
        ...
        bee> fio.pathjoin('/etc', 'default', 'myfile')
        ---
        - /etc/default/myfile
        ...
...
.. function:: basename(path-name[, suffix])
    ...
    .. code-block:: lua
        ...
        bee> fio.basename('/path/to/my.lua', '.lua')
        ---
        - my
        ...
...
.. function:: dirname(path-name)
    ...
    .. code-block:: lua
        ...
        bee> fio.dirname('/path/to/my.lua')
        ---
        - /path/to/
        ...
...
.. function:: umask(mask-bits)
    ...
    .. code-block:: lua
        ...
        bee> fio.umask(tonumber('755', 8)) -- pass 755 octal
        ---
        - 493
        ...
...
.. function:: link     (src , dst)
    ...
    .. code-block:: lua
        ...
        bee> fio.link('/home/username/tmp.txt', '/home/username/tmp.txt2')
        ---
        - true
        ...
        bee> fio.unlink('/home/pgulutzan/tmp.txt2')
        ---
        - true
        ...
...
.. function:: rename(path-name, new-path-name)
    ...
    .. code-block:: lua
        ...
        bee> fio.rename('/home/username/tmp.txt', '/home/username/tmp.txt2')
        ---
        - true
        ...
...
.. function:: chown(path-name, owner-user, owner-group)
    ...
    .. code-block:: lua
        ...
        bee> fio.chmod('/home/username/tmp.txt', tonumber('0755', 8))
        ---
        - true
        ...
...
.. function:: truncate(path-name, new-size)
    ...
    .. code-block:: lua
        ...
        bee> fio.truncate('/home/username/tmp.txt', 99999)
        ---
        - true
        ...
...
.. function:: open(path-name [, flags])
    ...
    .. code-block:: lua
        ...
        bee> fh = fio.open('/home/username/tmp.txt', {'O_RDWR', 'O_APPEND'})
        ---
        ...
        bee> fh -- display file handle returned by fio.open
        ---
        - fh: 11
        ...
...
.. class:: file-handle
    ...
    .. method:: close()
        ...
        .. code-block:: lua
            ...
            bee> fh:close() -- where fh = file-handle
            ---
            - true
            ...
