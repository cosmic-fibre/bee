...
.. function:: pack(format, argument [, argument ...])
    ...
    To use Bee binary protocol primitives from Lua, it's necessary to
    ...
    .. code-block:: lua
        ...
        bee> pickle = require('pickle')
        ---
        ...
        bee> db.space.tester:insert{0, 'hello world'}
        ---
        - [0, 'hello world']
        ...
        bee> db.space.tester:update({0}, {{'=', 2, 'bye world'}})
        ---
        - [0, 'bye world']
        ...
        bee> db.space.tester:update({0}, {{'=', 2, pickle.pack('iiA', 0, 3, 'hello')}})
        ---
        - [0, "\0\0\0\0\x03\0\0\0hello"]
        ...
        bee> db.space.tester:update({0}, {{'=', 2, 4}})
        ---
        - [0, 4]
        ...
        bee> db.space.tester:update({0}, {{'+', 2, 4}})
...
.. function:: unpack(format, binary-string)
    ...
    .. code-block:: lua
        ...
        ---
        ...
        bee> -- this means following commands must end with '!'
        bee> console = require('console'); console.delimiter('!')
        bee> tuple = db.space.tester:replace{0}!
        ---
        ...
        bee> string.len(tuple[1])!
        ---
        - 1
        ...
        bee> pickle.unpack('b', tuple[1])!
        ---
        - 48
        ...
        bee> pickle.unpack('bsi', pickle.pack('bsi', 255, 65535, 4294967295))!
        ---
        - 255
        - 65535
        - 4294967295
        ...
        bee> pickle.unpack('ls', pickle.pack('ls', tonumber64('18446744073709551615'), 65535))!
        ---
        - 18446744073709551615
        - 65535
        ...
        bee> num, str, num64 = pickle.unpack('sAl', pickle.pack('sAl', 666, 'string',
                ->                   tonumber64('666666666666666')))!
        ---
        ...
        bee> console.delimiter('') -- back to normal: commands end with line feed!
