...
:slug: db-protocol
:save_as: doc/db-protocol.html
:url: doc/db-protocol.html
...
a complete access to Bee functionality, including:
...
Bee protocol mandates use of a few integer constants serving as keys in
maps used in the protocol. These constants are defined in `src/db/iproto_constants.h
<https://github.com/bee/bee/blob/master/src/db/iproto_constants.h>`_
...
Bee is optional, if no authentication is performed, session user is 'guest'.
...
can be found in `src/db/errcode.h
<https://github.com/bee/bee/blob/master/src/db/errcode.h>`_
