...
function(apigen)
    set (dstfile "${CMAKE_CURRENT_BINARY_DIR}/bee.h")
    ...
    add_custom_command(OUTPUT ${dstfile}
        COMMAND cat ${CMAKE_CURRENT_SOURCE_DIR}/bee_header.h > ${tmpfile}
        COMMAND cat ${headers} | ${CMAKE_SOURCE_DIR}/extra/apigen >> ${tmpfile}
        COMMAND cat ${CMAKE_CURRENT_SOURCE_DIR}/bee_footer.h >> ${tmpfile}
        COMMAND ${CMAKE_COMMAND} -E copy_if_different ${tmpfile} ${dstfile}
        COMMAND ${CMAKE_COMMAND} -E remove ${tmpfile}
        DEPENDS ${srcfiles}
                ${CMAKE_CURRENT_SOURCE_DIR}/bee_header.h
                ${CMAKE_CURRENT_SOURCE_DIR}/bee_footer.h
        )
