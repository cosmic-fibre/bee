...
:BUILD
@REM LuaBinaries: 
@REM 	The current build system does not show 'lanes/lanes.dll' to
...
cl %WARN% %FLAGS% /I "%LUA51%\include" /Felanes\lanes.dll src\*.c "%LUA_LIB%\lua5.1.lib"
@REM cl %WARN% %FLAGS% /I "%LUA51%\include" /Felanes\lanes.dll src\*.c "%LUA_LIB%\lua5.1.lib" /link /NODEFAULTLIB:libcmt
